...
requests = {
    "missing": """Составь вопрос в формате предложения с пропущенным словом |rword|(|eword|) на тему |topic| с ответом |rword|. 
    ...
    """,
    "knowledge": """Составь вопрос на тему |topic| с коротким ответом |eword|, верни список составленных вопросов в формате json пример ниже   
    {
        "eng": "",
        "rus": "",
        "eng_answer": "|eword|",
    ...
    """,
    "definition": """Составь вопрос на тему |topic| с ответом |eword|, верни список составленных вопросов в формате json пример ниже   
    {
        "eng": "",
        "rus": "",
        "eng_answer": "",
    ...
    """,
    "translate": """Составь короткое предложение по тематике |topic| и запиши это в json формате, пример ниже
    {
        "eng": "",
        "rus": "",
    ...
    """,
    "boolean": """Составь вопрос по тематике |topic| в формате правда или ложь.
